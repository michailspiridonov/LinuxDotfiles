...
describe(`Tests for account creation`, () => {
    ...
    it(`Adds a billing address to the customer`, () => {
        ...
        cy.get(`div.message-success`).should(`contain`, `Ypu saved the address.`);
    });
    ...
    it(`Checks the addresses in magento`, () => {
        ...
        cy.get(`address`)
            ...
            .should(`contain`, customer.street)
            .should(`contain`, customer.city)
            .should(`contain`, customer.region)
            .should(`contain`, customer.postcode)
            .should(`contain`, customer.country)
            .should(`contain`, customer.telephone);
