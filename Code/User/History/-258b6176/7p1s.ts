...
describe(`Tests for account creation`, () => {
    ...
    it(`Creates a new customer`, () => {
        ...
        cy.get(UserRegistrationForm.firstName).type(customer.firstName);
        cy.get(UserRegistrationForm.lastName).type(customer.lastName);
        cy.get(UserRegistrationForm.email).type(customer.email);
        cy.get(UserRegistrationForm.password).type(customer.password);
        cy.get(UserRegistrationForm.confirmPassword).type(customer.password);
        //create the account
        cy.get(UserRegistrationForm.registerButton).click();
