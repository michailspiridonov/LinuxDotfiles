...
import { AdminUserDetailHandlers } from "../../handlers/admin/AdminUserDetailHandlers";
...
describe("Tests for account creation", () => {
	...
	it("Creates a new customer", () => {
		...
		AdminUserListHandlers.enterCustomerDetailPage(customer);
		...
		AdminFilterHandlers.filterTextByLabelText("Name", customer.firstName);
		cy.WaitForMagentoToLoad();
		AdminUserDetailHandlers.checkCustomerAddress(customer);
	});
});