...
describe("Search test", () => {
	...
	it.only("Tests advanced search by product short description", () => {
		cy.visit("/");
		cy.get(Homepage.footer_links.advanced_search).should("be.visible").first().click();
		AdminProductApiHandlers.getAllProducts().then(products => {
			const all_products = products;
			...
			SearchHandlers.advancedSearchByParameter(SearchPage.advanced_search_name_input, short_description);
		});
	});
