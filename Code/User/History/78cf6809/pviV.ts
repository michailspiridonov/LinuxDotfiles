...
Cypress.Commands.overwrite('click', (originalFn, subject, options) => {
  return originalFn(subject, { ...(<any>options), ...{ scrollBehavior: 'center' } })
})

Cypress.Commands.overwrite('clear', (originalFn, element, options) => {
  return originalFn(element, { ...(<any>options), ...{ scrollBehavior: 'center' } })
})

Cypress.Commands.overwrite('type', (originalFn, subject, text, options) => {
  return originalFn(subject, text, { ...(<any>options), ...{ scrollBehavior: 'center' } })
})

Cypress.Commands.overwrite('check', (originalFn, subject, value, options) => {
  return originalFn(subject, value, { ...(<any>options), ...{ scrollBehavior: 'center' } })
})

Cypress.Commands.overwrite('uncheck', (originalFn, subject, value, options) => {
  return originalFn(subject, value, { ...(<any>options), ...{ scrollBehavior: 'center' } })
})
