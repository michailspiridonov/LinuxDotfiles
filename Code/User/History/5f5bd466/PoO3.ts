...
describe("Create new user", () => {
  ...
  it("creates a new user", () => {
    ...
    cy.get(LoginScreenLocators.registation.primaryEmail).type('johndoe@example.com');
    cy.get(LoginScreenLocators.registation.emailRadioSelect).click();
    cy.get(LoginScreenLocators.registation.verificationEmail).type(Cypress.env("ATemail"));
