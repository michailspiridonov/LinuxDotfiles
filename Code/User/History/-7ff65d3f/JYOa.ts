...
describe('New User Registration', () => {
  ...
  if (!['cz'].includes(CONFIG_CONST.COUNTRY)) {
    ...
    it.only('2139 - New User Registration', { tags: [TAG.PROD_FRIENDLY, TAG.P1] }, () => {
      ...
      cy.getLoc(UserLocators.continue_button).click()
      CommonHandler.waitForFullLoad()
      ...
      cy.getLoc(UserLocators.continue_button).click()
      CommonHandler.waitForFullLoad()
      cy.get('html').contains(SuccessfullRegistrationPageText[CONFIG_CONST.COUNTRY])
    })
  } else {
    it.skip('SKIPPED')
  }
