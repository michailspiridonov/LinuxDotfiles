...
describe('Product Lists', () => {
  ...
  it('6122 - List of products in category', { tags: [TAG.PROD_FRIENDLY, TAG.P1] }, () => {
    ...
    cy.getLoc(CategoryLocators.category_list.locator).should('be.visible')
  ...
  if (['cz'].includes(CONFIG_CONST.COUNTRY)) {
    ...
    it.only('7555 - Product line', { tags: [TAG.PROD_FRIENDLY, TAG.CZ, TAG.P1] }, () => {
