export const UserLocators = {
  ...
  my_account_button: '[data-test-id="header-login-popover-account-link"]:nth-child(1)', // update when https://dev.azure.com/drmaxglobal/customer-team/_workitems/edit/9702 is completed
