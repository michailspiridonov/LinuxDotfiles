export const UserLocators = {
  ...
  my_account_button: {
    cmn: '[data-test-id="header-login-popover-account-link"]:nth-child(1)', // update when https://dev.azure.com/drmaxglobal/customer-team/_workitems/edit/9702 is completed,
    it: '.account__menu > :nth-child(1) > a'
  },
  ...
  logout_button: {
    cmn: '.account__menu > :nth-child(2) > .nuxt-link-exact-active',
    cz: '[data-test-id="header-login-popover-logout-link"]'
  },
  main_page_user_name: {
    cmn: '.login__logged__details',
    cz: '.sso__header strong a',
    ssb: '.login'
  },
  account_info: {
    ...
    billing_address: {
      street_and_house: '.mx-3 > :nth-child(2) > :nth-child(2)',
      city_and_postcode: '.mx-3 > :nth-child(2) > :nth-child(3)'
    },
    delivery_address: {
      street_and_house: '.mx-3 > :nth-child(3) > :nth-child(2)',
      city_and_postcode: '.mx-3 > :nth-child(3) > :nth-child(3)'
    },
