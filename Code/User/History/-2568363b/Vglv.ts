export const UserLocators = {
  ...
  user_profile_link: {
    cmn: '[data-test-id="header-login-link-logged-in"]',
    it: '.login__logged__btn'
  },
  login: {
    email: {
      cmn: '#email',
  ...
  logout_button: '[data-test-id="header-login-popover-logout-link"]',
  main_page_user_name: {
    cmn: "div[class*='login-profile']",
    cz: '.sso__header strong a',
    it: 'div.login__logged'
  },
  account_info: {
