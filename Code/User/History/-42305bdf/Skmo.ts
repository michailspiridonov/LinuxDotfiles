...
describe('Homepage', () => {
  ...
  it('5612 - L1 links leads to existing pages', { tags: [TAG.PROD_FRIENDLY, TAG.DEVCLOUD, TAG.P2] }, () => {
    ...
    cy.getLocScroll(GeneralLocators.megamenu.L1_items).scrollIntoView().should('be.visible')
  ...
  // Until new test case is created this test is replaced with the link checking one (except for ed & ssb)
