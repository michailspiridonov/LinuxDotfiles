...
describe('Homepage', () => {
  ...
  // Until new test case is created this test is replaced with the link checking one
  it.skip('5614 - L2 links lead to existing category pages', { tags: [TAG.PROD_FRIENDLY, TAG.DEVCLOUD, TAG.P2] }, () => {
    cy.getLocScroll(GeneralLocators.hamburger_menu.locator).click()
