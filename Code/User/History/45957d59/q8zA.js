...
const checkEmail = (emailSubject) => {
  ...
  cy.mailosaurGetMessage(serverId, {
	...
	it('', () => {
		cy.visit(regLink)
		cy.get(':nth-child(7) > .MuiBox-root > [style="position: relative;"] > .MuiFormControl-root > .MuiInputBase-root > .MuiInputBase-input').type('testPass')
		cy.get(':nth-child(8) > .MuiBox-root > [style="position: relative;"] > .MuiFormControl-root > .MuiInputBase-root > .MuiInputBase-input').type('testPass')
	})
});