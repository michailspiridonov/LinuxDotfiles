...
countries=( "cz" "sk" "ro" "pl" "it" "ssb" "ed" "ap" "cz_upgrade" ) # "cz" "sk" "ro" "pl" "it" "ssb" "ed" "ap"
products=( "all" ) # "all" "checkout" "catalog" "customer" "content" "platform"
grep_tags=( "all" )
specs="specs/content/visuals/megamenu.ts,specs/content/faq.ts,specs/content/homepage.ts"
cloud_nsf_url="-"
cloud_mag_url="-"
