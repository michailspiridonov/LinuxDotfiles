...
countries=( "cz" "sk" "ro" "pl" "it" "ssb" "ed" "ap" ) # "cz" "sk" "ro" "pl" "it" "ssb" "ed" "ap"
products=( "all" ) # "all" "checkout" "catalog" "customer" "content" "platform"
grep_tags=( "all" )
specs="specs/content/visuals/megamenu.ts,specs/customer/visuals.ts,specs/customer/login_logout.ts,specs/customer/otc.ts,specs/customer/password.ts,specs/checkout/e2e.ts,specs/checkout/administration/sales_rules.ts,specs/customer/registration.ts"
cloud_nsf_url="-"
cloud_mag_url="-"
