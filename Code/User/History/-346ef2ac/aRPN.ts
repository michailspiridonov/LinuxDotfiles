export const GeneralLocators = {
  megamenu: {
    ...
    back_btn: {
      cmn: '#smart-menu > nav > div > div.main-option__nav > button',
      ssb: '.main-option__nav > .btn'
    },
    logo: '#smart-menu > div.smart-menu__top > a.header__logo',
    L1_items: '.header-option__menu > li',
    L2_items: '.main-option__menu > li',
    category_title: '.main-option__text > h3',
    navigate_eshop: '.header-option__menu > #navigation-item-0',
